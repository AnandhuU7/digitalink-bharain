...
export default function AVSolutionPage() {
  ...
  const capabilities = [
    { title: "Projection Systems", image: ProjectSystem },
    { title: "Loud Speakers & Microphones", image: LoudSpeaker },
    { title: "Integrated Control Systems", image: Integrated },
    { title: "Discussion & Voting Systems", image: Discussion },
    { title: "Digital Signage Systems", image: Digital },
    { title: "Command & Control Rooms", image: Command }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div 
              ...
              variants={fadeInUp}
            >
              <span className="inline-block px-4 py-2 text-sm font-semibold text-indigo-600 uppercase tracking-wider bg-white rounded-full mb-4">
